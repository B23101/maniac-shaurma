 ...
 *   rotationY — завжди 0.
 *
 * Обидва задаються тут, при створенні, і передаються сутності перед
 * падінням: предмет лягає так, як упав. Якщо колись знадобиться інша
 * поведінка повороту — правка одна, у цьому класі, а не в кожному
 * предметі.
 */
